"""
Uploads Met Office Zarr folders from a specified directory to a Google Cloud Storage (GCS) bucket.
...
if __name__ == "__main__":
    ...
    directory = "/mnt/storage_b/data/ocf/solar_pv_nowcasting/nowcasting_dataset_pipeline/NWP/UK_Met_Office/UKV_ext/t5"
